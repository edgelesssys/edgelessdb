...
CREATE TABLE tmp_user_sys LIKE global_priv;
...
CREATE TABLE tmp_user_sys LIKE tables_priv;
...
-- and for upgrades
CREATE TABLE tmp_proxies_priv LIKE proxies_priv;
