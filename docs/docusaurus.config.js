...
async function createConfig() {
  ...
  return {
    title: 'EdgelessDB',
    url: 'https://edgelessdb-docs.netlify.app',
    baseUrl: '/edgelessdb/',
    onBrokenLinks: 'throw',
    ...
    projectName: 'edgelessdb', // Usually your repo name.
      ...
      [
        ...
        ({
          docs: {
            ...
            editUrl: 'https://github.com/edgelesssys/edgelessdb/edit/main/docs',
            routeBasePath: "/"
          },
          blog: false,
          theme: {
      ...
      ({
        navbar: {
          ...
          items: [
            ...
            // },
            {
              href: 'https://github.com/edgelesssys/edgelessdb',
              position: 'right',
          ...
          links: [
            {
              ...
              items: [
                {
                  label: 'Quickstart',
                  to: '/getting-started/quickstart-sgx',
                },
                {
                  label: 'Install',
